...
# Networking Module
# =============================================================================
# Creates the VPC, subnets, NAT gateways, and security groups for the
# Dynasty Futures infrastructure.
#
# Architecture:
# - 1 VPC with DNS support
# - 2 Public subnets (ALB, NAT Gateway)
# - 2 Private subnets (ECS, Lambda)
# - 2 Database subnets (Aurora, Redis)
...
resource "aws_elasticache_subnet_group" "cache" {
  ...
  subnet_ids  = aws_subnet.database[*].id # Using database subnets for cache too
...
resource "aws_security_group" "ecs" {
  ...
  ingress {
    ...
    from_port       = 3000 # Application port
    to_port         = 3000
    protocol        = "tcp"
